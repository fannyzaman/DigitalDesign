...
function checkConsensus() {
    ...
    if (maxCount >= 4) {
        ...
        showMessage('Consensus reached.\nColor: ' + maxColor, 2000); // Display message for 1 second
        nodes = nodes.map(() => maxColor); // Set all nodes to the consensus color
    } else {
        console.log('No consensus.\nUsing joker color: black');
        showMessage('No consensus.\nUsing joker color: black', 2000); // Display message for 1 second
